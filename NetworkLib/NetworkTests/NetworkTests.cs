...
namespace NetworkUtil
{
    ...
    public class NetworkTests
    {
        ...
        [DataRow(false)]
        [DataTestMethod]
        public void TestDisconnectLocalThenSendAndClose(bool clientSide)
        {
            SetupTestConnections(clientSide, out testListener, out testLocalSocketState, out testRemoteSocketState);
        ...
        /*** Begin SendAndClose/Receive Tests ***/
        ...
        [DataRow(false)]
        [DataTestMethod]
        public void TestNoEventLoopSendAndClose(bool clientSide)
        {
            SetupTestConnections(clientSide, out testListener, out testLocalSocketState, out testRemoteSocketState);
        ...
        [DataRow(false)]
        [DataTestMethod]
        public void TestDelayedSendAndClose(bool clientSide)
        {
            SetupTestConnections(clientSide, out testListener, out testLocalSocketState, out testRemoteSocketState);
            ...
            Networking.SendAndClose(testLocalSocketState.TheSocket, "b");
            Networking.GetData(testRemoteSocketState);
            // Note that waiting for data like this is *NOT* how the networking library is 
            // intended to be used. This is only for testing purposes.
            // Normally, you would provide an OnNetworkAction that handles the data.
